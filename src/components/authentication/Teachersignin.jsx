...
const TeacherSignIn = ({ role }) => {
  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="w-1/3 bg-pink-200 flex flex-col justify-center">
        <form
          onSubmit={handleSubmit}
          className="max-w-[800px] w-full ml-10px mt-10px rounded-lg bg-white p-8"
        >
          <h2 className="text-4xl font-bold text-center">Teacher Sign In</h2>
