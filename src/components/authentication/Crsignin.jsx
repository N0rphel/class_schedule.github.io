    ...
    <div className="flex justify-center">
      <div className="w-1/3 hidden sm:block">
        <img
          ...
          src={"./pictures/assets/pexels-julia-m-cameron-4145196.jpg"}
          alt=""
        />
      </div>
      <div className="bg-gray-200 flex flex-col justify-center">
        <form
          ...
          className="max-w-[800px] w-full mx-auto rounded-lg bg-white p-8"
        >
          <h2 className="text-4xl font-bold text-center">CR Sign In</h2>
